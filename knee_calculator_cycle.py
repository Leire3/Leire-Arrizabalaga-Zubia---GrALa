...
def knee_calculator_karga_2(cut_off_down, cut_off_up):

    #Datuak kargatu

    #Leundu gabe? Edo leundu tamaina 25 ? Edo leundu tamaina 75?
    '''
    #Leundu gabe
    if 
        window_length = 25
        knee_calculator_karga_leundua(cut_off_down, cut_off_up, window_lenght)
        ...
        knee_calculator_karga(cut_off_down, cut_off_up)
    '''
